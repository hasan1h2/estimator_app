...
class SinInPageView extends GetView<SinInPageController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        onTap: () {
          Get.toNamed(Routes.SIN_UP_PAGE);
        },
      ),
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomButton(
                bgColor:
                    StaticColors.btnColor, // Background color of the button
                ...
                onTap: () {
                  ...
                  ShowDialog.showCustomDialog(
                    context,
                    heading:
                        'Do you want to complete your profile?', // Dialog heading
                    seBtnTitle: 'Ok', // 'Ok' button text
                    fBtnTitle: 'Cancel', // 'Cancel' button text
                    onTap1: () => Get.toNamed(
                      Routes.MAIN_PAGE,
                    ), // Navigate to MAIN_PAGE on Ok
                    onTap2: () => Get.toNamed(
                      Routes.PROFILE_FROM_PAGE,
                    ), // Navigate to PROFILE_FROM_PAGE on Cancel
                    isSuccess: true, // Success flag for the dialog
                    lotiImg:
                        StaticImg.editLoti, // Lottie animation for the dialog
                  );
                },
