...
class FindCustomermPageView extends GetView<FindCustomermPageController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: Padding(
          padding: EdgeInsets.only(top: 98.h, left: 15.w, right: 15.w, bottom: 80.h),
          child: Column(
            ...
            children: [
              ...
              // Search Box Section
              SizedBox(height: 60.h, child: CustomSechBox(hintTextSiz: 16)),
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomerBtn(controlar: controller).marginOnly(left: 10,bottom: 10),
                        ],
                      ),
                    );
                  },
